...
# write_pages.py  – generates all Phase 1 JSX files
import os, textwrap
...
# ─── 2. ApplicationsPage ───────────────────────────────────────────────────────
w('src/pages/ApplicationsPage.jsx', '''
import React, { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { Plus, Trash2, Upload, RefreshCw, Play } from 'lucide-react';
import toast from 'react-hot-toast';
...
print('DashboardPage + ApplicationsPage written')
